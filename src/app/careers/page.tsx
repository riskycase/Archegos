...
const Careers = () => {
  return (
    ...
    leading-12 text-red-800 sm:text-3xl sm:mt-0 md:text-4xl md:mt-10"
          ...
          <div className="flex flex-col space-y-20 justify-center items-center lg:flex-row lg:space-x-12 lg:space-y-0 p-12">
            <div className="flex flex-col justify-center items-center bg-zinc-200 rounded-lg border-zinc-400 border-2 w-80 h-auto">
              ...
              <p className="text-lg text-red-800 font-semibold text-center px-2">
