...
export default function Home() {
  return (
    ...
    <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text center'>
      ...
      <div className='text-red-800 leading-10'>The name “Archegos” </div> <div className="max-w-4xl text-4xl leading-10">is derived from the Greek word meaning </div> <div className='text-red-800 leading-10'> “leading with example”. </div>  
      </h1>
      <p className='mt-5 max-w-prose text-zinc-700 sm:text-lg'>
      Our name is not just a title; it is a promise to our customers, partners and the communities we serve that we will continually pioneer new solutions and lead the industry towards a healthier future. 
      </p>
