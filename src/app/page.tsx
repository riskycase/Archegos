    ...
    <>
      ...
      <div className="bg-zinc-200 h-fit pt-20 file:flex flex-col justify-between items-center lg:flex-row">
        <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text center">
          <div className="flex flex-col space-y-20 lg:flex-row justify-center items-center mx-auto max-w-6x1 px-6 lg:p-8">
            ...
            <div className="flex flex-col ml-10 justify-center items-center rounded-lg border-zinc-400 border-2 w-80 h-100">
              ...
              <div className="text-md text-zinc-700 p-5 text-center">
                ...
                <span className="font-semibold">
                  {" "}
                  India&apos;s leading pharmaceutical manufacturers,
                </span>{" "}
                to offer a comprehensive portfolio of medicines that healthcare
                professionals and consumers can trust for their exceptional{" "}
                <span className="text-lg text-red-800 font-bold">
                  quality.{" "}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col ml-10 justify-center items-center rounded-lg border-zinc-400 border-2 w-80 h-90">
              ...
              <div className="text-md text-zinc-700 p-5 text-center">
                ...
                experience to{" "}
                <span className="font-semibold">
                  fulfil all their pharmaceutical needs.{" "}
                </span>
                ...
                to retailers, through a steady distribution network.
              </div>
            </div>
            ...
            <div className="flex flex-col ml-10 justify-center items-center rounded-lg border-zinc-400 border-2 w-80 h-100">
              ...
              <p className="text-md text-zinc-700 p-5 text-center">
                ...
                and communities across India. And to consolidate our
                brand&apos;s reputation as a symbol of excellence and{" "}
                <span className="text-lg text-red-800 font-bold">
                  {" "}
                  reliability{" "}
                </span>{" "}
          ...
          <p className="text-lg font-semibold p-20 text-zinc-700 text-center">
