  ...
  return (
      ...
      <div className="mt-20 max-w-full flex flex-col items-center justify-center lg:flex-row  md:flex-row md:space-x-10 sm:flex-col sm:mt-0">
        ...
        <ol className="space-y-5 p-10 md:mt-40 md:space-y-10 md:p-10 ">
          <li>
            ...
            className='grow-0'
            />
            <p className="font-semibold mt-2 max-w-prose text-lg text-zinc-700 sm:text-lg">To become a world-class and trusted pharmaceutical brand </p>
            </div>
          </li>
          <li>
            <div className="flex flex-row">
            ...
            className='grow-0'
            />
            <p className="font-semibold mt-2 max-w-prose text-lg text-zinc-700 sm:text-lg">To meet the critical need for reliable and effective medications</p>
            </div>
          </li>
          <li>
            <div className="flex flex-row">
            ...
            className='grow-0'
            />
            <p className="font-semibold mt-2 max-w-prose text-lg text-zinc-700 sm:text-lg">To offer every individual quality healthcare solutions right at their doorstep</p>
            </div>
          </li>
    ...
    <div className="bg-zinc-200">
      <MaxWidthWrapper className='mb-12 mt-28 flex flex-row items-center justify-center text center'>
        ...
        <p className="mb-20 text-center text-zinc-700 text-lg font-semibold md:mt-80 lg:mt-40">A team of visionary leaders, with decades of experience in the pharmaceutical and healthcare industry, 
